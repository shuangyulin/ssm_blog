...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>Blog/frontlist">博客信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">博客id:</div>
		<div class="col-md-10 col-xs-6"><%=blog.getBlogId()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">博客分类:</div>
		<div class="col-md-10 col-xs-6"><%=blog.getBlogClassObj().getBlogClassName() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">博客标题:</div>
		<div class="col-md-10 col-xs-6"><%=blog.getTitle()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">博客图片:</div>
		<div class="col-md-10 col-xs-6"><img class="img-responsive" src="<%=basePath %><%=blog.getBlogPhoto() %>"  border="0px"/></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">博客内容:</div>
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=blog.getShzt()%></div>
	</div>
	<div class="row bottom15">
