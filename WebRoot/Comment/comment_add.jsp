	...
	<form id="commentAddForm" enctype="multipart/form-data"  method="post">
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="comment_blogObj_blogId" name="comment.blogObj.blogId" style="width: auto"/>
			</span>
		</div>
		<div>
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="comment_commentTime" name="comment.commentTime" />
