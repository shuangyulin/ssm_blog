...
<div id="comment_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="commentQueryForm" method="post">
			被评博客：<input class="textbox" type="text" id="blogObj_blogId_query" name="blogObj.blogId" style="width: auto"/>
			评论人：<input class="textbox" type="text" id="userObj_user_name_query" name="userObj.user_name" style="width: auto"/>
			评论时间：<input type="text" id="commentTime" name="commentTime" class="easyui-datebox" editable="false" style="width:100px">
...
<div id="commentEditDiv">
	<form id="commentEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox"  id="comment_blogObj_blogId_edit" name="comment.blogObj.blogId" style="width: auto"/>
			</span>
		</div>
		<div>
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="comment_commentTime_edit" name="comment.commentTime" />
