...
<div id="blogClass_manage_tool" style="padding:5px;">
	<div style="margin-bottom:5px;">
		...
		<a href="#" class="easyui-linkbutton" iconCls="icon-reload" plain="true"  onclick="blogClass_manage_tool.reload();">刷新</a>
		<a href="#" class="easyui-linkbutton" iconCls="icon-redo" plain="true" onclick="blogClass_manage_tool.redo();">取消选择</a>
		<a href="#" class="easyui-linkbutton" iconCls="icon-export" plain="true" onclick="blogClass_manage_tool.exportExcel();">导出到excel</a>
	</div>
