				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>博客分类id</td><td>博客分类名称</td><td>博客分类介绍</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											<td><%=currentIndex %></td>
 											<td><%=blogClass.getBlogClassId() %></td>
 											<td><%=blogClass.getBlogClassName() %></td>
 											<td><%=blogClass.getBlogClassDesc() %></td>
 											<td>
 												<a href="<%=basePath  %>BlogClass/<%=blogClass.getBlogClassId() %>/frontshow"><i class="fa fa-info"></i>&nbsp;查看</a>&nbsp;
 												<a href="#" onclick="blogClassEdit('<%=blogClass.getBlogClassId() %>');" style="display:none;"><i class="fa fa-pencil fa-fw"></i>编辑</a>&nbsp;
 												<a href="#" onclick="blogClassDelete('<%=blogClass.getBlogClassId() %>');" style="display:none;"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										<%}%>
				    				</table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer"> 
      	...
      	<button type="button" class="btn btn-primary" onclick="ajaxBlogClassModify();">提交</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
{
    var pageValue=document.blogClassQueryForm.pageValue.value;
    if(pageValue>totalPage) {
        alert('你输入的页码超出了总页数!');
        return ;
    }
    document.blogClassQueryForm.currentPage.value = pageValue;
    documentblogClassQueryForm.submit();
}
